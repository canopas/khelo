  ...
  async createYouTubeStream(req, res) {
    try {
      ...
      const streamInfo = await this.liveStreamRepository.addStream({
        rtmp_url: streamResponse.data.cdn.ingestionInfo.rtmpsIngestionAddress + "/" + streamResponse.data.cdn.ingestionInfo.streamName,
        stream_id: streamResponse.data.id,
        server_url: streamResponse.data.cdn.ingestionInfo.rtmpsIngestionAddress,
        stream_name: streamResponse.data.cdn.ingestionInfo.streamName,
